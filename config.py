...
_C.DATASET.CAMERA_NUM = 6    # 使用的视角数量
...
# _C.TEST.TEST_CKPT = '/root/autodl-tmp/MVGFormerHandCheckpoints/20260225_203338_self_sup_mvgformer_dexycb/best_model.pth' # 测试用权重路径
_C.TEST.TEST_CKPT = '/root/MVGFormerHand/checkpoints/20260418_205603_self_sup_mvgformer_dexycb_numviews6/best_model.pth'
...
_C.DECODER.cross_attention_type = 'projective'  # 新增: 'projective' | 'vanilla'
...
_C.DECODER.loss_bone_prior = 10.0
